...
// End Cross Module References
	...
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UMenu_MenuSetup_Statics::NewProp_CustomLobbyPath = { "CustomLobbyPath", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(Menu_eventMenuSetup_Parms, CustomLobbyPath), METADATA_PARAMS(0, nullptr) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMenu_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UMenu_MenuSetup, "MenuSetup" }, // 38375377
		{ &Z_Construct_UFunction_UMenu_OnCreateSession, "OnCreateSession" }, // 1991492306
		...
		{ &Z_Construct_UFunction_UMenu_StartButtonClicked, "StartButtonClicked" }, // 351171956
	};
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UMenu_Statics::NewProp_StartButton = { "StartButton", nullptr, (EPropertyFlags)0x0040000000080008, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMenu, StartButton), Z_Construct_UClass_UButton_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMenu_Statics::NewProp_StartButton_MetaData), Z_Construct_UClass_UMenu_Statics::NewProp_StartButton_MetaData) };
	...
	UMenu::~UMenu() {}
	struct Z_CompiledInDeferFile_FID_Users_maske_Documents_Unreal_Projects_Hypergraph_ProjectHypergraph_Hypergraph_Plugins_MultiplayerSessions_Source_MultiplayerSessions_Public_Menu_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_maske_Documents_Unreal_Projects_Hypergraph_ProjectHypergraph_Hypergraph_Plugins_MultiplayerSessions_Source_MultiplayerSessions_Public_Menu_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMenu, UMenu::StaticClass, TEXT("UMenu"), &Z_Registration_Info_UClass_UMenu, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMenu), 3040160078U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_maske_Documents_Unreal_Projects_Hypergraph_ProjectHypergraph_Hypergraph_Plugins_MultiplayerSessions_Source_MultiplayerSessions_Public_Menu_h_4224122514(TEXT("/Script/MultiplayerSessions"),
		Z_CompiledInDeferFile_FID_Users_maske_Documents_Unreal_Projects_Hypergraph_ProjectHypergraph_Hypergraph_Plugins_MultiplayerSessions_Source_MultiplayerSessions_Public_Menu_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_maske_Documents_Unreal_Projects_Hypergraph_ProjectHypergraph_Hypergraph_Plugins_MultiplayerSessions_Source_MultiplayerSessions_Public_Menu_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
